...
const Sidebar = (): JSX.Element => {
  ...
  return (
    <div className="flex flex-col w-full pb-5">
      <div
        className="fixed top-0 bg-transparent m-auto"
        style={{
          opacity: `${isOpen ? "1" : "0"}`,
          alignSelf: 'center',
        }}
      ...
      <div className="w-[43%] h-[23vh] bg-[#e7e7ff] fixed transition-[0.6s] z-[1000] text-[#474545] rounded-b-xl rounded-bl-xl shadow-xl" style={{
        top: isOpen ? '-100%' : '0'
      }}>
